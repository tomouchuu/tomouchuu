<template>
    <div class="about-container">
        ...
        <p>Outside of coding, I'm a big fan of things japanese whether it's music (mostly IDOL (<a href="/oshimen" title="oshis">oshi-list</a>)), tv (not anime) or aesthetics and I try to get over there every 2 years at least. I also play drums occasionally, used to be in a band but I still keep playing to keep skills up, because of that I do finger drum in the office (sorry).</p>
